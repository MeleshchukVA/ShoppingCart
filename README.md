...
## Краткое описание
Приложение загружает каталог товаров из сети с возможностью добавить их в корзину и оформить заказ. Если перезапустить приложение, данные в корзине сохранятся и можно продолжить оформлять заказ.
...
Приложение состоит из 5 экранов, написанных на VIPER + онбординг. Каждый экран представляет из себя отдельный модуль.
...
https://user-images.githubusercontent.com/45876618/207379996-a8c2184a-8b50-449d-8440-8126eb74572a.mp4
...
https://user-images.githubusercontent.com/45876618/207393332-05837ad9-45cc-4097-9aee-2e3297b86cfa.mp4

- Анимированы кнопки добавления в корзину

https://user-images.githubusercontent.com/45876618/207393391-f33b2946-aea1-44e0-a637-791105ac2282.mp4

- Анимированы ячейки с товарами при нажатии на них
  
https://user-images.githubusercontent.com/45876618/207393421-d320eee6-da3a-40cb-a3e7-303defe6c175.mp4
...
- Отсутствие товаров в категории
  ...
  <img src="https://user-images.githubusercontent.com/45876618/207390757-27d91e38-8e19-4582-8f0f-a7c2c726680a.png" width="25%" height="25%"> <img src="https://user-images.githubusercontent.com/45876618/207390761-520ea66e-dc24-4850-a19f-ee8b656580fe.png" width="25%" height="25%"> 
  
  <img src="https://user-images.githubusercontent.com/45876618/207390752-6e756f3e-151e-4ec6-88b2-a328dc5ff0eb.png" width="25%" height="25%"> <img src="https://user-images.githubusercontent.com/45876618/207390744-367f71c3-9f25-4478-858d-51de25006502.png" width="25%" height="25%">
...
- презентеры модулей Catalogue, Cart, Product
- сервисы для работы с сетью и Core Data
