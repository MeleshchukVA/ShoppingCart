...
extension ProductCollectionViewAdapter: UICollectionViewDelegateFlowLayout {
    ...
    func itemWidth(for width: CGFloat, spacing: CGFloat) -> CGFloat {
        let totalSpacing: CGFloat = (ProductConstants.Layout.itemsInRow * ProductConstants.Layout.spacingLeft + (ProductConstants.Layout.itemsInRow - 1) * ProductConstants.Layout.spacingRight) + ProductConstants.Layout.minimumInteritemSpacingForSectionAt - ProductConstants.Layout.spacing
