...
final class ProductsCell: UICollectionViewCell {
    ...
    private lazy var imageView: UIImageView = {
        ...
        image.layer.cornerRadius = ProductsConstants.Layout.cornerRadius
...
extension ProductsCell: ProgrammaticallyInitializableViewProtocol {
    
    func setupView() {
        CurrencyFormatter.shared.configurate()
        layer.cornerRadius = ProductsConstants.Layout.cornerRadius
    ...
    func setupConstraints() {
        ...
        let constraints = [
            ...
            imageView.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor,
                                              constant: -(ProductsConstants.Layout.heightProductCard - 17)),
...
extension ProductsCell {
    ...
    func fill(with viewModel: ProductsViewModel) {
